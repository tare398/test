...
// if(!in_array($chatId, $premiumgp)){
	// $tch = json_decode(file_get_contents("https://api.telegram.org/bot1816615315:AAH9_Zh6dtekxEVm_b_cIACCVYML0Dp8e88/getChatMember?chat_id=@roldexverse&user_id=".$gId))->result->status;
...
// exit();
// }
        	// $tch = json_decode(file_get_contents("https://api.telegram.org/bot1816615315:AAH9_Zh6dtekxEVm_b_cIACCVYML0Dp8e88/getChatMember?chat_id=@roldexversechats&user_id=".$gId))->result->status;
// if($tch != 'member' && $tch != 'creator' && $tch != 'administrator'){
// bot('sendMessage',['chat_id'=>$chatId,'reply_to_message_id'=>$message_id,'text'=>"Sorry <a href='tg://user?id=$gId'>$firstname</a>
// 
// You Need To Join My Update Channel To Get Regular Updates
